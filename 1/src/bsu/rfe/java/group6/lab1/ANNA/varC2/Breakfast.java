...
//            {
//                if(item.par1.equals("сок"))
//                {
//                    if(item.par2.equals("вишня"))
//                        eatten_k1++;
//                    if(item.par2.equals("мята"))
//                        eatten_k2++;
//                }
//                if(item.par1.equals("кола"))
//                {
//                    if(item.par2.equals("вишня"))
//                        eatten_k3++;
//                    if(item.par2.equals("мята"))
...
//        System.out.println(" коктелей с соком и вишней - " + eatten_k1);
//        System.out.println(" коктелей с соком и мятой - " + eatten_k2);
//        System.out.println(" коктелей с колой и вишней - " + eatten_k3);
//        System.out.println(" коктелей с колой и мятой - " + eatten_k4);
//    }
